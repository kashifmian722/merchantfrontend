...
declare type IconShapeTupleAsString = [IconNameString, IconSvgString];
declare type IconShapeTupleAsObject = [IconNameString, IconSvgString];
export declare type IconShapeTuple = IconShapeTupleAsString | IconShapeTupleAsObject;
